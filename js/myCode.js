	...
	"public virtual function onGetOutput": function(pID, pParametersArray, pBody)
	{
		...
		if(pParametersArray['images'])
		{
			...
			for(var tKey in pParametersArray['images'])
			{
				...
				vReturn +=
				"<div class='image' style='display: none; width: 100%; height: 100%; overflow:auto; border-style:" +
				pParametersArray['borderstyle'] + "; border-color:" + pParametersArray['bordercolor'] + ";'>" +
				/*
...
$(document).ready(function()
{
	...
	/*
		...
		The first parameter be any arbitrary name.
